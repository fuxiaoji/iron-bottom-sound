...
| 回合 | 方 | 被搭载编队 | 精确编队 | 报告数 | 报告年龄 |
|---|---|---|---|---|---|
| 1–4 | axis | axis-active-heavy | `["axis-active-heavy"]` | 2 | [0, 0] |
| 1–5 | allies | allies-active-light | `["allies-active-light"]` | 2 | [0, 0] / [1, 6] … |
| 5 | axis | axis-active-heavy | `[]` | 1 | — |
...
- 实测报告年龄 `[0, 0]`（TBS 同回合可达，符合 §6 规则）到 `[1, 6]`（编码/转报路径）——年龄字段是真实退化，不是装饰。
