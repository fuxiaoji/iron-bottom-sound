...
export interface Ship{id:string;name:string;side:Side;ship_type:string;position:HexCoord|null;heading:number;current_speed:number;hull:number|null;max_hull:number|null;fire_markers:number;fired:boolean;sunk:boolean;asset:string|null;max_speed:number|null;torpedo_type:string|null;gun_mounts:GunMount[];torpedo_launchers:TorpedoLauncher[]}
