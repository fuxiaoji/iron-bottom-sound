...
export interface Observation{game_id:string;scenario_id:string;scenario_title:string;side:Side;turn:number;max_turns:number;phase:Phase;visibility:number;ships:Ship[];score:Record<string,number>;recent_events:Event[];winner:Side|null;victory_reason:string|null}
