...
const lessons:{phases:Phase[];title:string;goal:string;action:string;rule:string}[]=[
 ...
 {phases:["movement_planning"],title:"2. 编制移动",goal:"为每艘舰填写完整航路。",action:"点击地图棋子查看状态；在逐舰计划中输入航路。数字是直航 MF，P/S 是左/右转 60°，PP/SS 是 120°。第一次可把一艘舰改为 1，其余保持 0。",rule:"IBS-R-06 · 规则书 p.6–8"},
